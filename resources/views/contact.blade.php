...
@section('content')
    <!-- Contact Header -->
    <section class="bg-gradient-to-r text-black py-20">
        <div class="container mx-auto px-4">
            <h1 class="text-5xl font-bold text-center mb-4">{{ __('messages.contact') }}</h1>
            <p class="text-xl text-center text-black">{{ __('messages.contact_subtitle') }}</p>
        </div>
    </section>
